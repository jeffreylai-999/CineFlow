      ...
      <div className="flex min-h-svh">
        ...
        >
          ...
          <nav className="mt-6 flex flex-col gap-2 text-sm">
            ...
            {role === 'BOOKING_STAFF' ? (
              <>
                <NavLink className="rounded-md px-2 py-1 hover:bg-sidebar-accent" to="/staff/counter-sales">
                  Counter sales
                </NavLink>
                <NavLink className="rounded-md px-2 py-1 hover:bg-sidebar-accent" to="/staff/admission">
                  Admission
                </NavLink>
              </>
            ) : null}
            {role === 'ADMINISTRATOR' ? (
              <>
                <NavLink className="rounded-md px-2 py-1 hover:bg-sidebar-accent" to="/staff/movies">
                  Movies
                </NavLink>
                <NavLink className="rounded-md px-2 py-1 hover:bg-sidebar-accent" to="/staff/showtimes">
                  Showtimes
                </NavLink>
